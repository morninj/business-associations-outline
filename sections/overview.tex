...
\begin{enumerate}
    ...
    \begin{enumerate}
        ...
        making a business decision. \emph{Smith v. Van Gorkom}. If the board 
        was grossly negligent, entire fairness applies (see \emph{Beran}), and 
        the court will defer unless the board's action was irrational or 
        constituted waste. % TODO xref
        \begin{enumerate}
            \item But it can be awkward to use the entire fairness approach to 
            analyze the board's decisions \textbf{not to take action}. Those 
            situations are better analyzed under the \textbf{oversight 
            failure} rules, MBCA \S\ 8.31(a)(2)(iv) (see ``good faith'' 
            below).
        \end{enumerate}
    ...
    \begin{enumerate}
        ...
        \begin{enumerate}
            \item Definition of conflicting transaction and conflicted 
            director: see MBCA \S\ 8.60.
            ...
            transaction passes \emph{Beran}, it is entirely fair): % TODO xref
            \begin{enumerate}
...
\includepdf{resources/shareholder-fiduciary-duties.pdf}
...
\includepdf{resources/insider-trading.pdf}
